...
$eventID = 0;    
$sql = "SELECT MAX(eventID) AS id FROM Events";
    ...
    <button type="button" class="btn btn-primary" id="back-button">
      ...
      <div class="jumbotron">
        ...
        <p class="lead">Market your for-profit events through Event Eye!</p>
          <p><div class="description-small">Does your organization have a fundraising or other for-profit event that you’re looking to advertise? Submit your event to Event Eye using the Event Submission Form below and let us help you spread the word about your cause to the University of Maryland community. Our interactive map will make your event easy to locate and read details about, including attendee cost information and payment methods. Pricing for for-profit event submissions is dependent on how long your event is marketed on our site, and payment is collected via PayPal. For questions or more information, please contact eventeyeapp@gmail.com. </div> </p>
        </div>
<form class="form-horizontal" id="eventForm" role="form" data-toggle="validator" target="_top" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="lName" id="lName" placeholder="Doe" onblur="testFunction()" value="" required>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Email</label>
        <div class="col-sm-10">
            <input type="email" class="form-control" id="payer_email" placeholder="example@domain.com" value="" name="payer_email" required>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Event Name</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="eventName" name="eventName" placeholder="Best Event Ever" value="" onblur="testFunction()" required>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" name="otherLocation" id="otherLocation" placeholder="" onblur="testFunction()" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Room - if applicable</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="room" name="room" placeholder="Grand Ballroom" onblur="testFunction()" value="">
        </div>
    </div>
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="eventCost" name="eventCost" placeholder="$5 for Students, $10 for Visitors" value="" onblur="testFunction()" required>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select name="start-hour" id="start-hour" onblur="testFunction()" required>
            ...
            <label> : </label>
            <select name="start-minute" id="start-minute" onblur="testFunction()" required>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select name="end-hour" id="end-hour" onblur="testFunction()" required >
                <option value="01"> 1 </option>
                <option value="02"> 2 </option>
                <option value="03"> 3 </option>
                <option value="04"> 4 </option>
            ...
            <label> : </label>
            <select name="end-minute" id="end-minute" onblur="testFunction()" required>
                <option value="00"> 00 </option>
                <option value="05"> 05 </option>
                <option value="10"> 10 </option>
                <option value="15"> 15 </option>
            ...
            <select name="end-period" id="end-period" onblur="testFunction()" required>
                <option value="AM"> AM </option>
                <option value="PM"> PM </option>
            </select>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="description" id="description" placeholder="About your event, what do you want everyone to know?" value="" onblur="testFunction()" required>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Event Sponsor</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="sponsor" name="sponsor" placeholder="Club Name, Company Name, etc." value="" onblur="testFunction()">
        </div>
            </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Event Link</label>
        <div class="col-sm-10">
            <input type="url" class="form-control" id="eventLink" name="eventLink" placeholder="www.yourevent.com" value="" onblur="testFunction()">
        </div>
    </div>
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="invoice" value="<?php echo $eventID; ?>">
<input type="hidden" name="item_name" value="events">
<input type="hidden" name="hosted_button_id" value="37KR36GBHTXEA">
<input type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" onclick="submitForm()">
...
<script>
 function submitForm() {
     ...
     var firstName =            document.getElementById('fName').value;
            ...
            $.ajax({
            type: 'POST',
            url: 'databaseSubmit.php',
            data: {firstName: firstName, lastName: lastName, email: email, eventName: eventName, location:location, category:category, cost:cost, room:room, eventUrl: eventUrl, sponsor:sponsor, sTime:sTime, eTime:eTime, eventDate:eventDate, description:description},
            success: function() {
            },
            error: function() {
            }
