...
<script>
      ...
      <script>
        ...
        document.getElementById("pageDate").innerHTML = monthNames[m5] + " " + d5 + ", " + yyyy;  
        document.getElementById("intro").innerHTML = weekday[day5] + ", " + monthNames[m5] + " " + d5; 
