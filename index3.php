...
<script>
      ...
      <script>
        ...
        var day3 = dayThree.getDay();
        document.getElementById("day 3").innerHTML = monthNames[m3] + " "  + d3;
          
        document.getElementById("pageDate").innerHTML = monthNames[m3] + " " + d3 + ", " + yyyy;  
          
          document.getElementById("intro").innerHTML = weekday[day3] + ", " + monthNames[m3] + " " + d3;  
